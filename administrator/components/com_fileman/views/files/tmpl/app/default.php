...
<?= @template('com://admin/fileman.view.files.tmpl.app.initialize');?>
...
<div id="files-app">
	...
	<?= @template('com://admin/files.view.files.tmpl.templates_details'); ?>
	...
	<div id="files-canvas">
		...
		<?= @template('com://admin/fileman.view.files.tmpl.app.uploader');?>
	</div>
