...
class VmViewAdmin extends JViewLegacy {
	...
	*/
	public function display($tpl = null)
	{
		...
		$this->show_in_parent_window=$input->get('show_in_parent_window',0,'string');
		if ($this->show_in_parent_window==1) {
			...
			<script type="text/javascript">
				jQuery(document).ready(function ($) {
					$('#adminForm').asianventure_edit_from({
	...
	*/
	...
	function addStandardDefaultViewCommandsEditInline($showNew=true, $showDelete=true, $showHelp=true) {
