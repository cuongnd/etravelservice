...
//JHtml::_('behavior.formvalidator');
    ...
    $doc->addScript(JUri::root() . '/administrator/components/com_virtuemart/assets/js/asianventure.js');
    $doc->addLessStyleSheet(JUri::root() . '/administrator/components/com_virtuemart/assets/less/asianventure.less');
                    ...
                    <div class="span3 dashboard-left">
                        <div id="vertical_accordian_drop_down_menu_bar">
                            <div class='menu'>
                                <ul>
                                    <li class='active'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Dashboard</a>
                                    </li>
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Setup system</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=currency'><i
                                                        class="im-screen"></i>currency</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=paymentmethod'><i
                                                        class="im-screen"></i>Payment method</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Logistic</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=country'><i
                                                        class="im-screen"></i>GEO country</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=state'><i
                                                        class="im-screen"></i>Sate/province</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=cityarea'><i
                                                        class="im-screen"></i>city/area</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=groupsize'><i
                                                        class="im-screen"></i>Group size</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=tourclass'><i
                                                        class="im-screen"></i>tour class</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=activity'><i
                                                        class="im-screen"></i>Activities</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=tourstyle'><i
                                                        class="im-screen"></i>Tour style</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=tourtype'><i
                                                        class="im-screen"></i>Tour type</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=physicalgrade'><i
                                                        class="im-screen"></i>physical grade</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=hotel'><i
                                                        class="im-screen"></i>Hotel</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Tour
                                            build</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Genaral
                                                    build</a>
                                            </li>
                                            <li>
                                                <a href="index.php?option=com_virtuemart&view=highlight&virtuemart_product_id=<?php echo $virtuemart_product_id ?>"><i
                                                        class="im-screen"></i>Highlights</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=itinerary&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>itinerary</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=media'><i
                                                        class="im-screen"></i>Photo</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=document&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>Documents</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=tourprice&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>Tour price</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=relation&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>Relation</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=hotel&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>Hotel</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=faq&virtuemart_product_id=<?php echo $virtuemart_product_id ?>'><i
                                                        class="im-screen"></i>FAQs</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Tour Manager</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=product'><i
                                            ...
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=hoteladdon'><i
                                                        class="im-screen"></i>Hotel addon</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=tranferaddon'><i
                                    ...
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i
                                                class="im-screen"></i>Reservation</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=orders'><i
                                                        class="im-screen"></i>Reservation listing</a>
                                            </li>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=passenger'><i
                                    ...
                                    <li class='sub'>
                                        <a href='index.php?option=com_virtuemart'><i class="im-screen"></i>Customers</a>
                                        <ul>
                                            <li>
                                                <a href='index.php?option=com_virtuemart&view=user'><i
                                    ...
                                    <li class='last'>
                                        <a href='index.php?option=com_virtuemart&view=help'><i class="im-screen"></i>Help</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <?php if ($view != 'virtuemart') { ?>
                ...
                <div class="header-main-menu">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="index.php?option=com_virtuemart">Daskboard</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="logistic">
                            <div class="row-fluid">
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=country"><span
                                                    class="icon-palette" title=""></span>GEO contry</a></li>
                                        <li><a href="index.php?option=com_virtuemart&view=state"><span
                                ...
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=tourclass"><span
                                ...
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=tourtype"><span
                        ...
                        <div role="tabpanel" class="tab-pane" id="tour_manager">
                            <div class="row-fluid">
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=product"><span
                                                    class="icon-palette"
                                                    title=""></span>Tour
                                                listing</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane" id="sales_manager">
                            <div class="row-fluid">
                                ...
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=gift"><span
                                                    class="icon-palette" title=""></span>Gift</a></li>
                                        <li><a href="index.php?option=com_virtuemart&view=rewards"><span
                        ...
                        <div role="tabpanel" class="tab-pane" id="reservation">
                            <div class="row-fluid">
                                <div class="span2">
                                    <ul class="ul_sub_menu">
                                        <li><a href="index.php?option=com_virtuemart&view=orders"><span
                                                    class="icon-palette"
                                                    title=""></span>Reservation
                                                listing</a></li>
                                        <li><a href="index.php?option=com_virtuemart&view=passenger"><span
                                                    class="icon-palette" title=""></span>Passenger manager</a></li>
                                        <li><a href="index.php?option=com_virtuemart&view=conversition"><span
                                                    class="icon-palette" title=""></span>Conversition Manager</a></li>
                                        <li><a href='index.php?option=com_virtuemart&view=user'><i
