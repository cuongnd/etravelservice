...
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_virtuemart/assets/less/view_toursection_default.less');
...
if ($saveOrder)
{
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=toursection&task=saveOrderAjax&tmpl=component';
