...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    <div id="editcell">
		...
		<tr>
		    <th class="admin-checkbox">
				<label class="checkbox"><input type="checkbox" name="toggle" value=""
											   onclick="Joomla.checkAll(this)"/><?php  echo $this->sort('virtuemart_group_size_id','Id') ; ?></label>
		...
		<td align="left">
			...
			<?php } else { ?>
				<a href="<?php echo $editlink; ?>"><?php echo $row->group_name; ?>(<?php echo $row->from ?>,<?php echo $row->to ?>)</a>			<?php } ?>
		</td>
		<td align="left">
			<?php if ($show_edit) { ?>
