...
$doc->addScript(JUri::root() . '/administrator/components/com_virtuemart/assets/js/departure.js');
...
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_virtuemart/assets/less/departure.less');
