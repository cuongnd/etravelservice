...
if ($saveOrder)
{
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=language&task=saveOrderAjax&tmpl=component';
        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-striped" id="city_area_list" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=language&task=edit_in_line&virtuemart_country_id='.$row->virtuemart_country_id.'&cid[]=' . $row->virtuemart_language_id);
                    $edit = $this->gridEdit($row, $i, 'virtuemart_language_id', $editlink);
                    $save_link = JROUTE::_('index.php?option=com_virtuemart&view=language&task=save_in_line&cid[]=' . $row->virtuemart_language_id);
