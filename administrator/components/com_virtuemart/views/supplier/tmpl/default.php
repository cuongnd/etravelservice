...
$doc->addScript(JUri::root().'/administrator/components/com_virtuemart/assets/js/view_supplier_default.js');
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_virtuemart/assets/less/view_supplier_default.less');
...
if ($saveOrder)
{
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=supplier&task=saveOrderAjax&tmpl=component';
        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-striped" id="supplierList" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=supplier&task=show_parent_popup&cid[]=' . $row->virtuemart_supplier_id);
