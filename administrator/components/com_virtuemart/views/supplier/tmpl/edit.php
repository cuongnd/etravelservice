...
$doc->addLessStyleSheet(JUri::root() . '/administrator/components/com_virtuemart/assets/less/view_supplier_edit.less');
                            ...
                            <div class="row-fluid ">
                                <div class="span12">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6">
                                            <?php
                                            $iframe_link=JUri::base().'/index.php?option=com_virtuemart&view=servicetype&task=edit&cid[]=0';
                                            ?>
