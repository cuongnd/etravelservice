...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<tr>
	    <td width="100%">
			<?php echo $this->displayDefaultViewSearch ('highlight','search') ; ?>
	    </td>
	</tr>
    </table>
    <div id="editcell">
		...
		$checked = JHtml::_('grid.id', $i, $row->virtuemart_highlight_id);
			...
			$editlink = JROUTE::_('index.php?option=com_virtuemart&view=highlight&task=edit&cid[]=' . $row->virtuemart_highlight_id);
		?>
