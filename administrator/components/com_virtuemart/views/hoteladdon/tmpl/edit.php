...
$doc->addLessStyleSheet(JUri::root() . '/administrator/components/com_virtuemart/assets/less/view_hoteladdon_edit.less');
AdminUIHelper::startAdminArea($this);
AdminUIHelper::imitateTabs('start', "hoteladdon");
?>
	<div class="view-hoteladdon-edit">
		<form action="index.php" method="post" class="form-horizontal" name="adminForm" id="adminForm">
			...
			<input type="hidden" name="virtuemart_hoteladdon_id"
				   value="<?php echo $this->item->virtuemart_hoteladdon_id; ?>"/>
