...
$doc->addScript(JUri::root().'/administrator/components/com_virtuemart/assets/js/view_relation_default.js');
...
if ($saveOrder) {
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=relation&task=saveOrderAjax&tmpl=component';
            ...
            <div id="editcell">
				...
				<?php echo vmText::_('COM_VIRTUEMART_SHARED'); ?>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $editlink = JROUTE::_('index.php?option=com_virtuemart&view=relation&task=show_parent_popup&cid[]=' . $row->virtuemart_tour_type_id);
