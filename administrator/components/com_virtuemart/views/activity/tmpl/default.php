...
if ($saveOrder) {
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=activity&task=saveOrderAjax&tmpl=component';
...
-->        <div id="editcell">
            ...
            <table id="activity_list" class="adminlist table table-bordered table-striped" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=activity&task=show_parent_popup&cid[]=' . $row->virtuemart_activity_id.'&add_new_popup=1');
