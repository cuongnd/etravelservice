 ...
 */
class virtuemartViewpayment extends VmViewAdmin {
	...
	function display($tpl = null) {
		...
		if ($layoutName == 'edit') {
			...
			//get list tour
			require_once JPATH_ROOT . '/administrator/components/com_virtuemart/helpers/vmpayment.php';
			...
			//end get list tour
			require_once JPATH_ROOT.'/administrator/components/com_virtuemart/helpers/vmcurrency.php';
