...
$doc->addScript(JUri::root() . '/administrator/components/com_virtuemart/assets/js/view_paymentsetting_edit.js');
...
?>
    <div class="view-paymentsetting-edit">
        <form action="index.php" method="post" class="form-horizontal" name="adminForm" id="adminForm">
            ...
            <div class="col50">
                <fieldset>
                    <legend><?php echo vmText::_('Current paymentsetting'); ?></legend>
