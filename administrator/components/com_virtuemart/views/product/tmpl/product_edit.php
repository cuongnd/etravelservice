...
$document=JFactory::getDocument();
$document->addLessStyleSheet(JUri::root().'/administrator/components/com_virtuemart/assets/less/view_product_edit.less');
$document->addScript(JUri::root().'/administrator/components/com_virtuemart/assets/js/view_product_edit.js');
