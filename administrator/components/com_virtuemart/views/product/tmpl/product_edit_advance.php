...
<fieldset>
    ...
    <table class="adminform" width="100%">
        <tr class="row<?php echo $i ?>">
            ...
            <td>
                <span class="hastip"
                      title="<?php echo vmText::_('COM_VIRTUEMART_PRODUCT_FORM_ALIAS_TIP'); ?>"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_FORM_ALIAS') ?></span>
            </td>
            <td height="18">
        ...
        <tr class="row<?php echo $i ?>">
            ...
            <td>
                <input type="text" class="inputbox" name="product_url"
                       value="<?php echo $this->product->product_url; ?>" size="32" maxlength="255"/>
            </td>
        </tr>
        <?php $i = 1 - $i; ?>
        <tr class="row<?php echo $i ?>">
    ...
    <div class="button2-left btn-wrapper">
        <div class="blank">
            <a class="btn btn-small" href="#"
               id="add_new_price"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_ADD_PRICE') ?> </a>
        </div>
    </div>
