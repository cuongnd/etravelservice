    ...
    <div class="row-fluid ">
        <div class="span4">
            <fieldset>
                ...
                <?php echo VmHTML::row_control('input', 'Tour code', 'tour_code', 'sdfs4323dsd', 'class="required" readonly'); ?>
                <?php echo VmHTML::row_control('input', 'Select length', 'tour_length', $this->product->tour_length, 'class="required"'); ?>
                <?php echo VmHTML::row_control('select', 'Add country', 'country_id', $this->countries, $this->product->country_id, 'multiple', 'virtuemart_country_id', 'country_name', false); ?>
        ...
        <div class="span4">
            <fieldset>
                ...
                <?php echo VmHTML::row_control('select', 'Tour type', 'virtuemart_tour_type_id', $this->list_tour_type, $this->product->virtuemart_tour_type_id, 'multiple', 'virtuemart_tour_type_id', 'title', false); ?>
                <?php echo VmHTML::row_control('select', 'tour style', 'tour_style_id', $this->list_tour_style, $this->product->tour_style_id, '', 'virtuemart_tour_style_id', 'title', false); ?>
                ...
                <?php echo VmHTML::row_control('list_option', 'Price type', 'price_type', array('multi_price', 'unique_price','both_options'), $this->item->price_type, 'class="required"'); ?>
...
<div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="group_size">
        <div class="panel panel-default">
            <div class="panel-heading">Group size</div>
            <div class="panel-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row-fluid ">
                    ...
                    <div class="span4">
                        <?php echo VmHTML::row_control('textarea', 'inclusions', 'inclusions', $this->product->inclusions, 'class="required"', 30, 10); ?>
                    </div>
                    <div class="span4">
                        <?php echo VmHTML::row_control('textarea', 'exclusions', 'exclusions', $this->product->exclusions, 'class="required"', 30, 10); ?>
                    </div>
                </div>
                <div class="row-fluid ">
                    <div class="span6">
                        <?php echo VmHTML::row_control('textarea', 'Short description', 'product_s_desc', $this->product->product_s_desc, 'class="required"', 30, 10); ?>
                    </div>
                    <div class="span6">
                        <?php echo VmHTML::row_control('textarea', 'Long description', 'product_desc', $this->product->product_desc, 'class="required"', 30, 10); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane" id="meta_tag">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo VmHTML::textarea( 'meta_name', $this->product->meta_name, 'class="required"', 30, 10); ?>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane" id="trip_facts">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row-fluid ">
                    <div class="span12">
                        <div class="">Inserte active map</div>
                        <?php echo VmHTML::textarea( 'activite_map', $this->product->activite_map, 'class="required"', 30, 10); ?>
                    </div>
                </div>
                <div class="row-fluid ">
                    <div class="span12">
                        <div class="">Tour highlight</div>
                        <?php echo VmHTML::textarea('highlights', $this->product->highlights, 'class="required inputbox"', 30, 10); ?>
                    </div>
                </div>
                <div class="row-fluid ">
                    <div class="span12">
                        <div class="">Add private policy</div>
                        <?php echo VmHTML::textarea('private_policy', $this->product->private_policy, 'class="required inputbox"', 30, 10); ?>
                    </div>
                </div>
            </div>
        </div>
