...
if ($saveOrder)
{
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=country&task=saveOrderAjax&tmpl=component';
...
-->
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=country&task=edit_in_line&cid[]=' . $row->virtuemart_country_id);
                    $edit = $this->gridEdit($row, $i, 'virtuemart_country_id', $editlink);
                    $save_link = JROUTE::_('index.php?option=com_virtuemart&view=country&task=save_in_line&cid[]=' . $row->virtuemart_country_id);
