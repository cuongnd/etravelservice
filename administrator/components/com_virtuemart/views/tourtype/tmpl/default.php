...
if ($saveOrder) {
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=tourtype&task=saveOrderAjax&tmpl=component';
        ...
        <div id="editcell">
            ...
            <table id="tour_type_list" class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=tourtype&task=show_parent_popup&cid[]=' . $row->virtuemart_tour_type_id);
