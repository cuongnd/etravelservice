...
if ($saveOrder)
{
    ...
    $saveOrderingUrl = 'index.php?option=com_virtuemart&controller=servicetype&task=saveOrderAjax&tmpl=component';
        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-striped" id="servicetype_list" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_virtuemart&view=servicetype&task=edit_in_line&cid[]=' . $row->virtuemart_service_type_id);
                    $edit = $this->gridEdit($row, $i, 'virtuemart_service_type_id', $editlink);
                    $save_link = JROUTE::_('index.php?option=com_virtuemart&view=servicetype&task=save_in_line&cid[]=' . $row->virtuemart_service_type_id);
