...
{
    /*
     * These are required to keep Komento from creating notices.
     *
     * Since it accesses these properties by reference, we need to define them here.
     */
    public $text = '';
    public $introtext = '';
    ...
    {
        if ($column === 'alias' && !isset($this->_data['alias'])) {
