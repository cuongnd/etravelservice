(function ($) {
    ...
    // here we go!
    $.html_select_group_product = function (element, options) {
    ...
    $.fn.html_select_group_product = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {
            // if plugin has not already been attached to the element
            if (undefined == $(this).data('html_select_group_product')) {
                var plugin = new $.html_select_group_product(this, options);
                $(this).data('html_select_group_product', plugin);
