(function ($) {
    ...
    // here we go!
    $.html_build_passenger_summary = function (element, options) {
        ...
        var defaults = {
            ...
            element_key: 'html_build_passenger_summary',
            debug: false,
    ...
    $.fn.html_build_passenger_summary = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {
            // if plugin has not already been attached to the element
            if (undefined == $(this).data('html_build_passenger_summary')) {
                var plugin = new $.html_build_passenger_summary(this, options);
                $(this).data('html_build_passenger_summary', plugin);
