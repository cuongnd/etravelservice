(function ($) {
    ...
    $.html_build_extra_night_hotel = function (element, options) {
        ...
        plugin.update_data = function () {
            ...
            console.log(data.list_night_hotel);
        ...
        plugin.lock_passenger_selected_inside_room_index = function (room_index) {
            ...
            $.each($element_select_passenger,function(index,$passenger){
                ...
                for(var i=0;i<list_passenger_selected.length;i++){
                    ...
                    {
                        $self.find('option[value="'+passenger_index+'"]').prop("disabled", true);
                    }
                }
...
*/
        ...
        plugin.enable_change_total_room_number = function (room_index,$room_type) {
            return true;
        };
        ...
        plugin.change_total_room_number = function (hotel_night_index,$room_type) {
            ...
            $wapper_room_type.find('.remove_room').click(function(){
                ...
                if($night_hotel.find('.list_room_type_passenger .'+room_type+' .passenger-item').length>1)
                {
        ...
        plugin.add_event_night_hotel_item_index = function (room_index) {
            var $room_item = $element.find('.item-night-hotel:eq(' + room_index + ')');
            ...
            $list_passenger.find('input.passenger-item').each(function (passenger_index) {
                ...
                if (!$passenger.hasClass(event_class)) {
                    $passenger.change(function (event) {
                        ...
                        var $self = $(this);
                        var a_room_index = $self.closest('.item-night-hotel').index();
                        $room_item = $self.closest('.item-night-hotel');
            ...
            if (!$room_item.find(element).hasClass(event_class)) {
                $room_item.find(element).change(function () {
                    var a_room_index = $(this).closest('.item-night-hotel').index();
                    var $a_room_item = $(this).closest('.item-night-hotel');
                    var $room_type=$(this);
            ...
            if (!$room_item.find('.date').hasClass(event_class)) {
                ...
                $room_item.find('.date').daterangepicker({
            ...
            if(debug)
            {
                ...
                if (!$room_item.find('textarea[data-name="room_note"]').hasClass(event_class)) {
                    ...
                    $room_item.find('textarea[data-name="room_note"]').change(function () {
                        plugin.update_night_hotel_note_night_hotel_index(room_index);
                    }).addClass(event_class);
                }
            }
