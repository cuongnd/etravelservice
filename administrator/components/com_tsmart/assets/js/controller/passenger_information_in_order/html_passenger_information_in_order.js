(function ($) {
    ...
    // here we go!
    $.html_passenger_information_in_order = function (element, options) {
        ...
        var defaults = {
            ...
            element_key: 'html_passenger_information_in_order',
            debug: false,
    ...
    $.fn.html_passenger_information_in_order = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {
            // if plugin has not already been attached to the element
            if (undefined == $(this).data('html_passenger_information_in_order')) {
                var plugin = new $.html_passenger_information_in_order(this, options);
                $(this).data('html_passenger_information_in_order', plugin);
