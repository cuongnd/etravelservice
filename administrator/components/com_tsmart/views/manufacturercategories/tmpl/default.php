...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div id="editcell">
		...
		for ($i=0, $n=count( $this->manufacturerCategories ); $i < $n; $i++) {
			...
			$editlink = JROUTE::_('index.php?option=com_tsmart&view=manufacturercategories&task=edit&virtuemart_manufacturercategories_id=' . $row->virtuemart_manufacturercategories_id);
			$manufacturersList = JROUTE::_('index.php?option=com_tsmart&view=manufacturer&virtuemart_manufacturercategories_id=' . $row->virtuemart_manufacturercategories_id);
