        ...
        <div class="payment-body">
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    ...
                    <?php echo VmHTML::row_control('hold_seat_option', 'Hold seat option', 'hold_seat','hold_seat_hours','hold_seat_orderstate_id', $this->item->hold_seat,$this->item->hold_seat_hours,$this->item->hold_seat_orderstate_id); ?>
