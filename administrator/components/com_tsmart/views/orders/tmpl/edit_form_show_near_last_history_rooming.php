...
$doc->addLessStyleSheet(JUri::root().'administrator/components/com_tsmart/assets/less/view_orders_edit_form_show_near_last_history_rooming.less');
...
$i = 0;
?>
<div class="view_orders_edit_form_show_near_last_history_rooming form-horizontal">
    <div class="row-fluid ">
        <div class="span12">
            <table class="adminlist table table-striped near_last_history_rooming" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                        <th >
