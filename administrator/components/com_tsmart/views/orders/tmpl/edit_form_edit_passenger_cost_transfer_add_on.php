...
$doc->addLessStyleSheet(JUri::root().'administrator/components/com_tsmart/assets/less/view_edit_form_edit_passenger_cost_transfer_add_on.less');
...
$i = 0;
?>
<div class="view_edit_form_edit_passenger_cost_transfer_add_on form-horizontal">
    <div class="row-fluid ">
        <div class="span12">
            <div class="vm-page-nav text-center ">
                <h3 class="text-uppercase"><?php echo JText::_('Passenger cost') ?></h3>
            </div>
            <table class="adminlist table table-striped edit_passenger_cost_transfer_addon_edit_passenger" cellspacing="0" cellpadding="0">
                <thead>
                <tr>
