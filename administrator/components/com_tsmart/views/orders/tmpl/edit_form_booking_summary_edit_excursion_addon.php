        ...
        <div class="span12">
            ...
            <table class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><span class="group_excursion_current_discount"><?php echo JText::_("N/A") ?></span></td>
                    <td><span class="group_excursion_current_commission"><?php echo JText::_("N/A") ?></span></td>
                    <td><span class="net_total"></span></td>
                    <td><input type="text" class="group_excursion_current_payment"></td>
                    <td><span class="balance"></span></td>
                    <td><span class="cancel"><?php echo JText::_("N/A") ?></span></td>
                    <td><span class="refund"><?php echo JText::_("N/A") ?></span></td>
                    <td>
                        <?php echo VmHTML::change_order_status(array(), 'excursion_add_on_status', 0, ''); ?>
                    </td>
