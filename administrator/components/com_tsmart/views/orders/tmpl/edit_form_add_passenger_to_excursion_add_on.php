...
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_tsmart/assets/less/view_edit_form_add_passenger_to_excursion_add_on.less')
// set row counter
?>
<div class="view_edit_form_add_passenger_to_excursion_add_on form-horizontal">
    <div class="row-fluid ">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <select disable_chosen="true" class="total_passenger_excursion">
        ...
        <div class="table-add-passenger-to-excursion">
            ...
            <div class="body-table-add-passenger-to-excursion">
