        ...
        <div class="span12">
            ...
            <table class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><span class="group_transfer_current_discount"></span></td>
                    <td><span class="group_transfer_current_commission"></span></td>
                    <td><span class="net_total"></span></td>
                    <td><input type="text" class="group_transfer_current_payment"></td>
