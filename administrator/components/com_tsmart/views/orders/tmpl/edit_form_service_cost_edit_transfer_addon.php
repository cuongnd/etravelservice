...
$doc->addLessStyleSheet(JUri::root().'administrator/components/com_tsmart/assets/less/view_orders_edit_form_edit_service_cost_edit_transfer.less');
...
<div class="view_orders_edit_form_edit_service_cost_edit_transfer form-horizontal">
    <div class="row-fluid ">
        <div class="span12">
