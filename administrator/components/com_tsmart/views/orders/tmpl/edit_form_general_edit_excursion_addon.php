        ...
        <div class="span12">
            <fieldset class="general">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <?php echo VmHTML::row_control('textarea', 'Terms & condition','excursion_terms_condition_readonly', "",' readonly ',100,4); ?>
                        <?php echo VmHTML::row_control('textarea', 'Reservation notes','excursion_reservation_notes_readonly', "",' readonly ',100,4); ?>
