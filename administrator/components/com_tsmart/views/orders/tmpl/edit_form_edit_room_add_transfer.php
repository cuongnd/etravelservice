        ...
        <div class="span12">
            ...
            <div class="row">
                <div class="span12">
                    ...
                    ?>
                    <?php echo VmHtml::_('buil_rooming_list.rooming_list',$this->list_passenger_not_in_temporary_and_not_in_room,'add_transfer_rooming_list','',$this->departure,$this->passenger_config,$this->debug);?>
                </div>
            </div>
