...
<div class="col50">
	...
	<input type="hidden" name="tsmart_vendor_id" value="<?php echo $this->currency->tsmart_vendor_id; ?>" />
	<input type="hidden" name="tsmart_currency_id" value="<?php echo $this->currency->tsmart_currency_id; ?>" />
