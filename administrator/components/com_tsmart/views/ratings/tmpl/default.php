	...
	<table>
	  <tr>
		 <td align="left" width="100%">
			...
			<button class="btn btn-small" onclick="document.adminForm.filter_ratings.value='';"><?php echo tsmText::_('com_tsmart_RESET'); ?></button>
		...
		foreach ($this->ratingslist as $key => $review) {
			...
			<tr class="row<?php echo $k ; ?>">
				...
				<td align="center">
				    ...
				    <span title="<?php echo (tsmText::_("com_tsmart_RATING_TITLE").' '. round($review->rating) . '/' . $maxrating) ?>" class="ratingbox" style="display:inline-block;">
