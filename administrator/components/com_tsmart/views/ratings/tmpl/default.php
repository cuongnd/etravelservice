	...
	<table>
	  <tr>
		 <td align="left" width="100%">
			...
			<button class="btn btn-small" onclick="document.adminForm.filter_ratings.value='';"><?php echo vmText::_('com_tsmart_RESET'); ?></button>
...
<div style="text-align: left;">
	...
	<tr>
		...
		<th width="40%"><?php echo $this->sort('created_on', 'com_tsmart_DATE') ; ?></th>
		<th width="40%"><?php echo $this->sort('product_name') ; ?></th>
		<th width="10%"><?php echo $this->sort('rating', 'com_tsmart_RATE_NOM') ; ?></th>
	...
	if (count($this->ratingslist) > 0) {
		...
		foreach ($this->ratingslist as $key => $review) {
			...
			<tr class="row<?php echo $k ; ?>">
				...
				<td><?php echo JHtml::_('link', $link,vmJsApi::date($review->created_on,'LC2',true) , array("title" => vmText::_('com_tsmart_RATING_EDIT_TITLE'))); ?></td>
				<!-- Product name -->
				...
				<td align="center">
				    ...
				    <span title="<?php echo (vmText::_("com_tsmart_RATING_TITLE").' '. round($review->rating) . '/' . $maxrating) ?>" class="ratingbox" style="display:inline-block;">
