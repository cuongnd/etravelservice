...
<div id="filterbox">
	...
	<div id="editcell">
		...
		<tr>
			...
			<th style="min-width:80px;width:8%;align:center;">
				<?php echo $this->sort( 'c.ordering' , 'com_tsmart_ORDERING') ?>
				<?php echo JHtml::_('grid.order', $this->categories, 'filesave.png', 'saveOrder' ); ?>
			</th>
			<th align="center" >
				<?php echo $this->sort('c.published' , 'com_tsmart_PUBLISHED') ?>
			</th>
			<?php if($this->showVendors()){ ?>
					<th>
					<?php echo $this->sort( 'cx.category_shared' , 'com_tsmart_SHARED') ?>
					</th>
			<?php } ?>
