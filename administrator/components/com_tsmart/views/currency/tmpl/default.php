        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-striped" id="city_area_list" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_tsmart&view=currency&task=edit_in_line&virtuemart_country_id='.$row->virtuemart_country_id.'&cid[]=' . $row->virtuemart_currency_id);
                    $edit = $this->gridEdit($row, $i, 'virtuemart_currency_id', $editlink);
                    $save_link = JROUTE::_('index.php?option=com_tsmart&view=currency&task=save_in_line&cid[]=' . $row->virtuemart_currency_id);
