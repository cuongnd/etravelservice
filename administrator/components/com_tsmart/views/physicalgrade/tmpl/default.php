        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-bordered table-striped" id="tour_class_list" cellspacing="0"
                ...
                <tr>
                    <th class="admin-checkbox">
                        <label class="checkbox"><input type="checkbox" name="toggle" value=""
                                                       onclick="Joomla.checkAll(this)"/><?php echo $this->sort('tsmart_physicalgrade_id', 'Id'); ?>
                        </label>
                    </th>
                    <th>
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_tsmart&view=physicalgrade&task=show_parent_popup&cid[]=' . $row->tsmart_physicalgrade_id);
