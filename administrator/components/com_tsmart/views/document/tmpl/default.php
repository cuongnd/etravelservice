...
$doc->addScript(JUri::root().'/administrator/components/com_tsmart/assets/js/view_document_default.js');
...
if ($saveOrder) {
    ...
    $saveOrderingUrl = 'index.php?option=com_tsmart&controller=document&task=saveOrderAjax&tmpl=component';
            ...
            <div id="editcell">
				...
				<?php echo vmText::_('com_tsmart_SHARED'); ?>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $editlink = JROUTE::_('index.php?option=com_tsmart&view=document&task=show_parent_popup&cid[]=' . $row->virtuemart_document_id);
