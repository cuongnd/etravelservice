...
AdminUIHelper::imitateTabs('start', "discount");
?>
	<div class="view-discount-edit">
		<form action="index.php" method="post" class="form-horizontal" name="adminForm" id="adminForm">
			...
			<div class="col50">
				<fieldset>
					<legend><?php echo tsmText::_('Current discount'); ?></legend>
					<div class="row-fluid">
						<div class="span7">
			...
			<input type="hidden" name="tsmart_discount_id"
				   value="<?php echo $this->item->tsmart_discount_id; ?>"/>
