...
$doc->addScript(JUri::root() . '/administrator/components/com_tsmart/assets/js/view_coupon_default.js');
...
$doc->addLessStyleSheet(JUri::root() . '/administrator/components/com_tsmart/assets/less/view_coupon_default.less');
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $('.view-coupon-default').view_coupon_default({
            task: "<?php echo $task ?>"
        });
    });
</script>
        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th>
                        <?php echo $this->sort('hotel_name', 'Coupon name'); ?>
                    </th>
                    <th>
                        <?php echo $this->sort('created_on', 'Create date'); ?>
                    </th>
                    <th>
                        <?php echo $this->sort('location', 'Coupon code'); ?>
                    </th>
                    <th>
