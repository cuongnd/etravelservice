	    ...
	    <table class="adminlist table table-striped" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th>
                        <?php echo $this->sort('order_subtotal_netto', 'com_tsmart_REPORT_BASIC_REVENUE_NETTO') ; ?>
                    </th>
                    <th>
		                <?php echo $this->sort('order_subtotal_brutto', 'com_tsmart_REPORT_BASIC_REVENUE_BRUTTO') ; ?>
                    </th>
                <?php
