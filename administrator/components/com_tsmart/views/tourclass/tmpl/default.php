...
$doc->addScript(JUri::root() . '/administrator/components/com_tsmart/assets/js/view_tourclass_default.js');
        ...
        <div id="editcell">
            ...
            <table class="adminlist table table-bordered table-striped" id="tour_class_list" cellspacing="0"
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_tsmart&view=tourclass&task=show_parent_popup&cid[]=' . $row->tsmart_service_class_id);
