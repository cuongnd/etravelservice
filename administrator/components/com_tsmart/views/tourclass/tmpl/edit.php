...
$doc->addScript(JUri::root() . '/administrator/components/com_tsmart/assets/js/view_tourclass_edit.js');
...
?>
    <div class="view-tourclass-edit">
        <form action="index.php" method="post" class="form-horizontal" name="adminForm" id="adminForm">
            ...
            <input type="hidden" name="tsmart_service_class_id"
                   value="<?php echo $this->item->tsmart_service_class_id; ?>"/>
