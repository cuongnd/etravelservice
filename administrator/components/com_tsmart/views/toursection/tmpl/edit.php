...
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_tsmart/assets/less/view_tour_section_edit.less');
...
?>
    <div class="view-hotel-edit">
        <form action="index.php" method="post" class="form-vertical" name="adminForm" id="adminForm">
            ...
            <input type="hidden" name="tsmart_hotel_id" value="<?php echo $this->item->tsmart_tour_section_id; ?>"/>
