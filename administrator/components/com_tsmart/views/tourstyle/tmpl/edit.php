...
$doc->addLessStyleSheet(JUri::root().'/administrator/components/com_tsmart/assets/less/view_tourstyle_edit.less');
...
?>
    <div class="view-hotel-edit">
        <form action="index.php" method="post" class="form-vertical" name="adminForm" id="adminForm">
            ...
            <div class="col50">
                <fieldset>
                    ...
                    <div class="admintable row-fluid">
                        <div class="span12">
                            <?php echo VmHTML::row_control('input', 'Tour section name', 'tour_style_name', $this->item->tour_style_name, 'class="required"'); ?>
            ...
            <input type="hidden" name="tsmart_hotel_id" value="<?php echo $this->item->tsmart_tourstyle_id; ?>"/>
