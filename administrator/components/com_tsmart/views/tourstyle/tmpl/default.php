        ...
        <div id="editcell">
            ...
            <table id="tour_style_list" class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $checked = JHtml::_('grid.id', $i, $row->tsmart_tour_style_id);
                    $published = $this->gridPublished($row, $i);

                    $editlink = JROUTE::_('index.php?option=com_tsmart&view=tourstyle&task=show_parent_popup&cid[]=' . $row->tsmart_tour_style_id);
                    $edit = $this->gridEdit($row, $i, 'tsmart_tour_style_id', $editlink);
                    $delete = $this->grid_delete_in_line($row, $i, 'tsmart_tour_style_id');
                    ?>
