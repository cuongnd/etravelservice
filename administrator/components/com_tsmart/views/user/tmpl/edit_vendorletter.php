			...
			<td valign="top">
				<fieldset>
					...
					<table class="admintable">
						...
						<?php echo VmHTML::row('checkbox', 'com_tsmart_VENDOR_LETTER_ADD_TOS',
							'vendor_letter_add_tos', $this->vendor->vendor_letter_add_tos); ?> 
						<?php echo VmHTML::row('checkbox', 'com_tsmart_VENDOR_LETTER_ADD_TOS_PAGEBREAK',
...
// 									echo JHtml::link('http://dev.tsmart.net/','Get More Fonts!','target="_blank"');
								?>
							</td>
						</tr>
						<tr>
