...
* @version $Id: default.php 8828 2015-04-13 13:58:32Z Milbo $
*/
...
<form action="<?php echo JRoute::_( 'index.php' );?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="editcell">
		...
		<tr>
			...
			<th width="25%"><?php echo $this->sort('ju.username', 'com_tsmart_USERNAME')  ?></th>
			<th width="25%"><?php echo $this->sort('ju.name', 'com_tsmart_USER_DISPLAYED_NAME')  ?></th>
