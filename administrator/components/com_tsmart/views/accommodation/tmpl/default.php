        ...
        <div id="editcell">
            ...
            <table id="tour_type_list" class="adminlist table table-striped" cellspacing="0" cellpadding="0">
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $editlink = JROUTE::_('index.php?option=com_tsmart&view=accommodation&task=' . ($row->virtuemart_accommodation_id ? 'add_new_item' : 'edit_item') . '&cid[]=' . $row->virtuemart_accommodation_id . '&virtuemart_product_id=' . $row->virtuemart_product_id.'&virtuemart_itinerary_id='.$row->virtuemart_itinerary_id);
