...
<div class="col50">
	...
	<table class="admintable">
		...
		echo VmHTML::row('checkbox','com_tsmart_SHARED', 'shared', $this->calc->shared );
		} ?>
		<?php echo VmHTML::row('input','com_tsmart_ORDERING','ordering',$this->calc->ordering,'class="inputbox"','',4,4); ?>
		<?php echo VmHTML::row('input','com_tsmart_DESCRIPTION','calc_descr',$this->calc->calc_descr,'class="inputbox"','',70,255); ?>
		...
		<?php echo VmHTML::row('raw','com_tsmart_SHOPPERGROUP_IDS', $this->shopperGroupList ); ?>
		<?php echo VmHTML::row('raw','com_tsmart_COUNTRY', $this->countriesList ); ?>
		<?php echo VmHTML::row('raw','com_tsmart_STATE_S', $this->statesList ); ?>
		<?php echo VmHTML::row('raw','com_tsmart_MANUFACTURER', $this->manufacturerList ); /* Mod. <mediaDESIGN> St.Kraft 2013-02-24 Herstellerrabatt */ ?>

		<?php //echo VmHTML::row('booleanlist','com_tsmart_VISIBLE_FOR_SHOPPER','calc_shopper_published',$this->calc->calc_shopper_published); ?>
		<?php //echo VmHTML::row('booleanlist','com_tsmart_VISIBLE_FOR_VENDOR','calc_vendor_published',$this->calc->calc_vendor_published); ?>
		<?php
