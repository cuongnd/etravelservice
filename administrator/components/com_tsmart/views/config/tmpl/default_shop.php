...
<fieldset>
	...
	<table class="admintable">
		...
		<?php
			echo VmHTML::row('checkbox','com_tsmart_ADMIN_CFG_USE_ONLY_AS_CATALOGUE','use_as_catalog',VmConfig::get('use_as_catalog',0));
			echo VmHTML::row('genericlist','com_tsmart_CFG_CURRENCY_MODULE',$this->currConverterList, 'currency_converter_module', 'size=1', 'value', 'text', VmConfig::get('currency_converter_module', 'convertECB.php'));
			echo VmHTML::row('checkbox','com_tsmart_ADMIN_CFG_ENABLE_CONTENT_PLUGIN','enable_content_plugin',VmConfig::get('enable_content_plugin',0));

			echo VmHTML::row('checkbox','com_tsmart_ADMIN_CFG_SSL','useSSL',VmConfig::get('useSSL',0));
			echo VmHTML::row('checkbox','com_tsmart_REGISTRATION_CAPTCHA','reg_captcha',VmConfig::get('reg_captcha',0));
			echo VmHTML::row('checkbox','com_tsmart_VM_ERROR_HANDLING_ENABLE','handle_404',VmConfig::get('handle_404',1));
		?>
	</table>
</fieldset>
...
<fieldset>
	...
	<table class="admintable">
		...
		<?php
			echo VmHTML::row('checkbox','com_tsmart_ADMIN_CFG_ENABLE_ENGLISH','enableEnglish',VmConfig::get('enableEnglish',1));
		?>
