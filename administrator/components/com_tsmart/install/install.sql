-- tsmart table SQL script
-- This will install all the tables need to run tsmart


--
-- Table structure for table `#__tsmart_adminmenuentries`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_adminmenuentries` (
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_calcs`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_calcs` (
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT 'Belongs to vendor',
  ...
  PRIMARY KEY (`tsmart_calc_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  KEY `published` (`published`),
...
--
-- Table structure for table `#__tsmart_calc_categories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_calc_categories` (
  `id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_category_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_calc_id` (`tsmart_calc_id`,`tsmart_category_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;


CREATE TABLE IF NOT EXISTS `#__tsmart_calc_manufacturers` (
  `id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_manufacturer_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_calc_id` (`tsmart_calc_id`,`tsmart_manufacturer_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_calc_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_calc_shoppergroups` (
  `id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_calc_id` (`tsmart_calc_id`,`tsmart_shoppergroup_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_calc_countries`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_calc_countries` (
  `id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_country_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_calc_id` (`tsmart_calc_id`,`tsmart_country_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_calc_states`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_calc_states` (
  `id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_state_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_calc_id` (`tsmart_calc_id`,`tsmart_state_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `#__tsmart_categories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_categories` (
  `tsmart_category_id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT 'Belongs to vendor',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_category_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  KEY `published` (`published`),
  KEY `shared` (`shared`),
  KEY `ordering` (`ordering`)
...
--
-- Table structure for table `#__tsmart_category_categories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_category_categories` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `#__tsmart_category_medias`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_category_medias` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_category_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_media_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ordering` (`ordering`),
  UNIQUE KEY `tsmart_category_id` (`tsmart_category_id`,`tsmart_media_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `#__tsmart_countries`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_countries` (
  `tsmart_country_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_worldzone_id` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `#__tsmart_coupons`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_coupons` (
  `tsmart_coupon_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` INT(1) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__tsmart_carts` (
  `tsmart_cart_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_user_id` INT(1) UNSIGNED NOT NULL,
  `tsmart_vendor_id` INT(1) UNSIGNED NOT NULL,
  ...
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_cart_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  KEY `tsmart_user_id` (`tsmart_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='Used to store the cart';

-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_currencies`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_currencies` (
  `tsmart_currency_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_currency_id`),
  KEY `ordering` (`ordering`),
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_customs`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_customs` (
  `tsmart_custom_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `custom_parent_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `#__tsmart_invoices` (
  `tsmart_invoice_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1',
  `tsmart_order_id` int(1) UNSIGNED,
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_invoice_id`),
  UNIQUE KEY `invoice_number` (`invoice_number`,`tsmart_vendor_id`),
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_manufacturers`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_manufacturers` (
  `tsmart_manufacturer_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_manufacturercategories_id` int(1),
  `hits` int(1) unsigned NOT NULL DEFAULT '0',
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by` int(1) NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_manufacturer_id`),
  UNIQUE KEY `tsmart_manufacturercategories_id` (`tsmart_manufacturer_id`,`tsmart_manufacturercategories_id`),
  KEY `published` (`published`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Manufacturers are those who deliver products' AUTO_INCREMENT=1 ;

--
-- Table structure for table `#__tsmart_manufacturer_medias`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_manufacturer_medias` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_manufacturer_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_media_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ordering` (`ordering`),
  UNIQUE KEY `tsmart_manufacturer_id` (`tsmart_manufacturer_id`,`tsmart_media_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_manufacturercategories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_manufacturercategories` (
  `tsmart_manufacturercategories_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by` int(1) NOT NULL DEFAULT '0',
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_manufacturercategories_id`),
  KEY `published` (`published`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_medias` (was  `#__tsmart_product_files`)
--

CREATE TABLE IF NOT EXISTS `#__tsmart_medias` (
  `tsmart_media_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_migration_oldtonew_ids` (only used for migration)
--

CREATE TABLE IF NOT EXISTS `#__tsmart_migration_oldtonew_ids` (
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_modules`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_modules` (
  ...
  KEY `ordering` (`ordering`),
  KEY `published` (`published`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='tsmart Core Modules, not: Joomla modules' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_orders`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_orders` (
  `tsmart_order_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_user_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `tsmart_paymentmethod_id` int(1) UNSIGNED,
  `tsmart_shipmentmethod_id` int(1) UNSIGNED,
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_order_id`),
  KEY `tsmart_user_id` (`tsmart_user_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  KEY `order_number` (`order_number`),
  KEY `tsmart_paymentmethod_id` (`tsmart_paymentmethod_id`),
  KEY `tsmart_shipmentmethod_id` (`tsmart_shipmentmethod_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Used to store all orders' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_order_histories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_order_histories` (
  `tsmart_order_history_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_order_history_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores all actions and changes that occur to an order' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_order_items`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_order_items` (
  `tsmart_order_item_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_order_id` int(1),
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  `tsmart_product_id` int(1),
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_order_item_id`),
...
--
-- Table structure for table `#__tsmart_order_calc_rules`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_order_calc_rules` (
  `tsmart_order_calc_rule_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_calc_id` int(1),
  `tsmart_order_id` int(1),
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  `tsmart_order_item_id` int(1),
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_order_calc_rule_id`),
  KEY `tsmart_calc_id` (`tsmart_calc_id`),
  KEY `tsmart_order_id` (`tsmart_order_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`)
...
--
-- Table structure for table `#__tsmart_orderstates`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_orderstates` (
  `tsmart_orderstate_id` tinyint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_orderstate_id`),
  KEY `ordering` (`ordering`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  KEY `published` (`published`)
...
--
-- Table structure for table `#__tsmart_paymentmethods`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_paymentmethods` (
  `tsmart_paymentmethod_id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_paymentmethod_id`),
	KEY `payment_jplugin_id` (`payment_jplugin_id`),
	KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
	KEY `payment_element` (payment_element,`tsmart_vendor_id`),
	KEY `ordering` (`ordering`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_paymentmethod_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_paymentmethod_shoppergroups` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_paymentmethod_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_paymentmethod_id` (`tsmart_paymentmethod_id`,`tsmart_shoppergroup_id`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_products`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_products` (
  `tsmart_product_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1',
...
--
-- Table structure for table `#__tsmart_product_categories`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_categories` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_category_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`tsmart_category_id`),
  KEY `ordering` (`ordering`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='Maps Products to Categories';

-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_product_shoppergroups`
--
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_shoppergroups` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`tsmart_shoppergroup_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='Maps Products to Categories';

-- --------------------------------------------------------
--
-- Table structure `#__tsmart_product_customfields`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_customfields` (
  `tsmart_customfield_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'field id',
  `tsmart_product_id` int(1) NOT NULL DEFAULT '0',
  `tsmart_custom_id` int(1) NOT NULL DEFAULT '1' COMMENT 'custom group id',
  ...
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_customfield_id`),
  KEY `tsmart_product_id` (`tsmart_product_id`),
  KEY `tsmart_custom_id` (`tsmart_custom_id`),
  KEY `published` (`published`),
  KEY `ordering` (`ordering`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_product_medias`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_medias` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_media_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`tsmart_media_id`),
  KEY `ordering` (`ordering`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_product_manufacturers`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_manufacturers` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1),
  `tsmart_manufacturer_id` smallint(1) UNSIGNED,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`tsmart_manufacturer_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='Maps a product to a manufacturer';


-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_product_prices`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_product_prices` (
  `tsmart_product_price_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED  NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_product_price_id`),
  KEY `tsmart_product_id` (`tsmart_product_id`),
  KEY `product_price` (`tsmart_product_id`),
  KEY `tsmart_shoppergroup_id` (`tsmart_shoppergroup_id`),
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_rating_reviews`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_rating_reviews` (
  `tsmart_rating_review_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_rating_review_id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`created_by`),
  KEY `created_on` (`created_on`),
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_ratings`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_ratings` (
  `tsmart_rating_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_rating_id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`tsmart_rating_id`),
  KEY `published` (`published`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_rating_votes`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_rating_votes` (
  `tsmart_rating_vote_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_rating_vote_id`),
  UNIQUE KEY `tsmart_product_id` (`tsmart_product_id`,`created_by`),
  KEY `created_by` (`created_by`),
  KEY `created_on` (`created_on`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='Stores all ratings for a product';
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_shipmentmethods`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_shipmentmethods` (
  `tsmart_shipmentmethod_id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_shipmentmethod_id`),
	KEY `shipment_jplugin_id` (`shipment_jplugin_id`),
	KEY `shipment_element` (shipment_element,`tsmart_vendor_id`),
	KEY `ordering` (`ordering`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_shipmentmethods_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_shipmentmethod_shoppergroups` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_shipmentmethod_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_shipmentmethod_id` (`tsmart_shipmentmethod_id`,`tsmart_shoppergroup_id`)
...
--
-- Table structure for table `#__tsmart_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_shoppergroups` (
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_shoppergroup_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
...
--
-- Table structure for table `#__tsmart_states`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_states` (
  `tsmart_state_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1',
  `tsmart_country_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_worldzone_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `state_name` char(64),
  `state_3_code` char(3),
  `state_2_code` char(2),
  `ordering` int(1) NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_state_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  UNIQUE KEY `state_3_code` (`tsmart_vendor_id`,`tsmart_country_id`,`state_3_code`),
  UNIQUE KEY `state_2_code` (`tsmart_vendor_id`,`tsmart_country_id`,`state_2_code`),
  KEY `tsmart_country_id` (`tsmart_country_id`),
  KEY `ordering` (`ordering`),
  KEY `shared` (`shared`),
  KEY `published` (`published`)
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tsmart_userfields`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_userfields` (
  `tsmart_userfield_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '1',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_userfield_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
...
--
-- Table structure for table `#__tsmart_userfield_values`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_userfield_values` (
  `tsmart_userfield_value_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_userfield_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_userfield_value_id`),
  KEY `tsmart_userfield_id` (`tsmart_userfield_id`)
...
--
-- Table structure for table `#__tsmart_vendors`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_vendors` (
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `vendor_name` char(64),
...
--
-- Table structure for table `#__tsmart_vendor_medias`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_vendor_medias` (
  `id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_media_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_vendor_id` (`tsmart_vendor_id`,`tsmart_media_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;


CREATE TABLE IF NOT EXISTS `#__tsmart_vendor_users` (
  `id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_user_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_vendor_id` (`tsmart_vendor_id`,`tsmart_user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `#__tsmart_vmusers`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_vmusers` (
  `tsmart_user_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_user_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`),
  UNIQUE KEY `u_tsmart_user_id` (`tsmart_user_id`,`tsmart_vendor_id`),
...
--
-- Table structure for table `#__tsmart_vmuser_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_vmuser_shoppergroups` (
  `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_user_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_shoppergroup_id` smallint(1) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tsmart_user_id` (`tsmart_user_id`,`tsmart_shoppergroup_id`)
...
--
-- Table structure for table `#__tsmart_waitingusers`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_waitingusers` (
  `tsmart_waitinguser_id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_product_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  `tsmart_user_id` int(1) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_waitinguser_id`),
  KEY `tsmart_product_id` (`tsmart_product_id`),
...
--
-- Table structure for table `#__tsmart_worldzones`
--

CREATE TABLE IF NOT EXISTS `#__tsmart_worldzones` (
  `tsmart_worldzone_id` smallint(1) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tsmart_vendor_id` smallint(1),
  `zone_name` char(255),
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`tsmart_worldzone_id`),
  KEY `tsmart_vendor_id` (`tsmart_vendor_id`)
