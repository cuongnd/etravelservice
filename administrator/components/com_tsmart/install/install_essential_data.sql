...
(null, 1, 0, 'com_tsmart_PRODUCT_INVENTORY', '', '', 'vmicon vmicon-16-price_watch', 7, 1, '', 'inventory', ''),
(null, 1, 0, 'com_tsmart_CALC_S', '', '', 'vmicon vmicon-16-calculator', 8, 1, '', 'calc', ''),
(null, 1, 0, 'com_tsmart_REVIEW_RATE_S', '', '', 'vmicon vmicon-16-comments', 9, 1, '', 'ratings', ''),
(null, 2, 0, 'com_tsmart_ORDER_S', '', '', 'vmicon vmicon-16-page_white_stack', 1, 1, '', 'orders', ''),
(null, 2, 0, 'com_tsmart_COUPON_S', '', '', 'vmicon vmicon-16-shopping', 10, 1, '', 'coupon', ''),
(null, 2, 0, 'com_tsmart_REPORT', '', '', 'vmicon vmicon-16-chart_bar', 3, 1, '', 'report',''),
(null, 2, 0, 'com_tsmart_USER_S', '', '', 'vmicon vmicon-16-user', 4, 1, '', 'user', ''),
(null, 2, 0, 'com_tsmart_SHOPPERGROUP_S', '', '', 'vmicon vmicon-16-user-group', 5, 1, '', 'shoppergroup', ''),
(null, 3, 0, 'com_tsmart_MANUFACTURER_S', '', '', 'vmicon vmicon-16-wrench_orange', 1, 1, '', 'manufacturer', ''),
(null, 3, 0, 'com_tsmart_MANUFACTURER_CATEGORY_S', '', '', 'vmicon vmicon-16-folder_wrench', 2, 1, '', 'manufacturercategories', ''),
(null, 4, 0, 'com_tsmart_STORE', '', '', 'vmicon vmicon-16-reseller_account_template', 1, 1, '', 'user', 'editshop'),
(null, 4, 0, 'com_tsmart_MEDIA_S', '', '', 'vmicon vmicon-16-pictures', 2, 1, '', 'media', ''),
(null, 4, 0, 'com_tsmart_SHIPMENTMETHOD_S', '', '', 'vmicon vmicon-16-lorry', 3, 1, '', 'shipmentmethod', ''),
(null, 4, 0, 'com_tsmart_PAYMENTMETHOD_S', '', '', 'vmicon vmicon-16-creditcards', 4, 1, '', 'paymentmethod', ''),
(null, 5, 0, 'com_tsmart_CONFIGURATION', '', '', 'vmicon vmicon-16-config', 1, 1, '', 'config', ''),
(null, 5, 0, 'com_tsmart_USERFIELD_S', '', '', 'vmicon vmicon-16-participation_rate', 2, 1, '', 'userfields', ''),
(null, 5, 0, 'com_tsmart_ORDERSTATUS_S', '', '', 'vmicon vmicon-16-document_editing', 3, 1, '', 'orderstatus', ''),
(null, 5, 0, 'com_tsmart_CURRENCY_S', '', '', 'vmicon vmicon-16-coins', 5, 1, '', 'currency', ''),
...
(null, 'X', 'com_tsmart_ORDER_STATUS_CANCELLED', '', 'A',4, 1),
(null, 'R', 'com_tsmart_ORDER_STATUS_REFUNDED', '', 'A',5, 1),
(null, 'S', 'com_tsmart_ORDER_STATUS_SHIPPED', '', 'O',6, 1),
(null, 'F', 'com_tsmart_ORDER_STATUS_COMPLETED', '', 'R',7, 1),
(null, 'D', 'com_tsmart_ORDER_STATUS_DENIED', '', 'A',8, 1);
...
INSERT INTO `#__virtuemart_userfields` (`virtuemart_userfield_id`, `virtuemart_vendor_id`, `userfield_jplugin_id`, `name`, `title`, `description`, `type`, `maxlength`, `size`, `required`, `cols`, `rows`, `value`, `default`, `registration`, `shipment`, `account`, `cart`, `readonly`, `calculated`, `sys`, `userfield_params`, `ordering`, `shared`, `published`) VALUES
	...
	(8, 0, 0, 'password', 'com_tsmart_SHOPPER_FORM_PASSWORD_1', '', 'password', 25, 30, 1, NULL, NULL, NULL, NULL, 1, 0, 1, 0, 0, 0, 1, NULL, 10, 0, 1),
	(9, 0, 0, 'password2', 'com_tsmart_SHOPPER_FORM_PASSWORD_2', '', 'password', 25, 30, 1, NULL, NULL, NULL, NULL, 1, 0, 1, 0, 0, 0, 1, NULL, 12, 0, 1),
	(15, 0, 0, 'agreed', 'com_tsmart_I_AGREE_TO_TOS', '', 'checkbox', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 1, NULL, 13, 0, 1),
	(16, 0, 0, 'tos', 'com_tsmart_STORE_FORM_TOS', '', 'custom', NULL, NULL, 1, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 0, 0, 1, NULL, 14, 0, 1),
	(17, 0, 0, 'customer_note', 'com_tsmart_CNOTES_CART', '', 'textarea', 2500, NULL, 0, 60, 1, NULL, NULL, 0, 0, 0, 1, 0, 0, 1, NULL, 13, 0, 1),
	(20, 0, 0, 'address_type_name', 'com_tsmart_USER_FORM_ADDRESS_LABEL', '', 'text', 32, 30, 1, NULL, NULL, NULL, 'com_tsmart_USER_FORM_ST_LABEL', 0, 1, 0, 0, 0, 0, 1, NULL, 16, 0, 1),
	(21, 0, 0, 'delimiter_billto', 'com_tsmart_USER_FORM_BILLTO_LBL', '', 'delimiter', 25, 30, 0, NULL, NULL, NULL, NULL, 1, 0, 1, 0, 0, 0, 0, NULL, 18, 0, 1),
	(22, 0, 0, 'company', 'com_tsmart_SHOPPER_FORM_COMPANY_NAME', '', 'text', 64, 30, 0, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 1, NULL, 20, 0, 1),
	(23, 0, 0, 'title', 'com_tsmart_SHOPPER_FORM_TITLE', '', 'select', 0, 210, 0, NULL, NULL, NULL, NULL, 1, 0, 1, 0, 0, 0, 1, NULL, 22, 0, 1),
	(24, 0, 0, 'first_name', 'com_tsmart_SHOPPER_FORM_FIRST_NAME', '', 'text', 32, 30, 1, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 1, NULL, 24, 0, 1),
	(25, 0, 0, 'middle_name', 'com_tsmart_SHOPPER_FORM_MIDDLE_NAME', '', 'text', 32, 30, 0, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 1, NULL, 26, 0, 1),
	(26, 0, 0, 'last_name', 'com_tsmart_SHOPPER_FORM_LAST_NAME', '', 'text', 32, 30, 1, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 1, NULL, 28, 0, 1),
	(27, 0, 0, 'address_1', 'com_tsmart_SHOPPER_FORM_ADDRESS_1', '', 'text', 64, 30, 1, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 1, NULL, 30, 0, 1),
	...
	(41, 0, 0, 'delimiter_sendregistration', 'com_tsmart_BUTTON_SEND_REG', '', 'delimiter', 25, 30, 0, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NULL, 2, 0, 1),
	(42, 0, 0, 'delimiter_userinfo', 'com_tsmart_ORDER_PRINT_CUST_INFO_LBL', '', 'delimiter', NULL, NULL, 0, NULL, NULL, NULL, NULL, 1, 0, 1, 0, 0, 0, 0, NULL, 14, 0, 1),
	(50, 0, 0, 'tax_exemption_number', 'com_tsmart_SHOPPER_FORM_TAXEXEMPTION_NBR', 'Vendors can set here a tax exemption number for a shopper. This field is only changeable by administrators.', 'text', 10, 0, 0, 0, 0, NULL, NULL, 0, 0, 1, 1, 0, 0, 0, NULL, 48, 0, 0),
	(51, 0, 0, 'tax_usage_type', 'com_tsmart_SHOPPER_FORM_TAX_USAGE', 'Federal, national, educational, public, or similar often get a special tax. This field is only writable by administrators.', 'select', 0, 0, 0, 0, 0, NULL, NULL, 0, 0, 1, 1, 0, 0, 0, NULL, 50, 0, 0);