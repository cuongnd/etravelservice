...
class vmexcursionaddon
{
    ...
    public static function get_list_tour_id_by_excursion_addon_id($virtuemart_excursion_addon_id=0)
    {
        $db=JFactory::getDbo();
        $query=$db->getQuery(true);
        $query->select('virtuemart_product_id')
            ->from('#__virtuemart_tour_id_excursion_addon_id')
