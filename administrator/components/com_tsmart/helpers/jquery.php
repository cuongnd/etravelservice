...
abstract class TSMHtmlJquery
{
    ...
    public static function framework($noConflict = true, $debug = null, $migrate = true)
    {
        ...
        if ($jquery_compress) {
            $doc->addScript('/media/jquery-ui-1.11.1/external/jquery-1.9.1/jquery.js');
            $doc->addScript('/components/com_tsmart/assets/js/plugin/jquery.easing-master/jquery.easing.min.js');
            if ($noConflict) {
                $doc->addScript('/components/com_tsmart/assets/js/jquery.noconflict.js');
            }
    ...
    public static function ui($debug = null)
    {
        ...
        if (empty(static::$loaded[__METHOD__])) {
            $doc = JFactory::getDocument();
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/jquery-ui.js');
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/ui/position.js');
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/ui/widget.js');
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/ui/button.js');
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/ui/draggable.js');
            $doc->addStyleSheet(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery-ui-1.11.1/themes/base/all.css');
            static::$loaded[__METHOD__] = true;
        }
        return;
    }

    public static function numeric($debug = null)
    {
        // Include jQuery
        static::framework();
        // If no debugging value is set, use the configuration setting
    ...
    public static function serializeobject($debug = null)
    {
        ...
        if (empty(static::$loaded[__METHOD__])) {
            $doc = JFactory::getDocument();
            $doc->addScript(JUri::root() . 'administrator/components/com_tsmart/assets/js/plugin/jquery.serializeobject-master/jquery.serializeObject.js');
            static::$loaded[__METHOD__] = true;
        }
        return;
    }
    ...
    public static function alert($debug = null)
    {
        $jquery_alert_compress = false;
        $jquery_alert_css_compress = false;
        // Include jQuery
        static::framework();
        // If no debugging value is set, use the configuration setting
        if ($debug === null) {
        ...
        if (empty(static::$loaded[__METHOD__])) {
            $doc = JFactory::getDocument();
            if ($jquery_alert_compress) {
                $doc->addScript(JUri::root() . 'components/com_tsmart/assets/js/plugin/Animated-jQuery-Modal/src/js/dreyanim.min.js');
                $doc->addScript(JUri::root() . 'components/com_tsmart/assets/js/plugin/Animated-jQuery-Modal/src/js/dreymodal.min.js');
            } else {
            ...
            if ($jquery_alert_css_compress) {
                $doc->addStyleSheet(JUri::root() . 'components/com_tsmart/assets/js/plugin/Animated-jQuery-Modal/src/css/dreyanim.min.css');
                $doc->addStyleSheet(JUri::root() . 'components/com_tsmart/assets/js/plugin/Animated-jQuery-Modal/src/css/dreymodal.min.css');
            } else {
