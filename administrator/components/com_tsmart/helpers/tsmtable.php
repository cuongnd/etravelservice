...
class tsmTable extends vObject implements  JObservableInterface, JTableInterface {
	...
	public function setPrimaryKey($key, $keyForm = 0) {
		...
		$error = tsmText::sprintf('com_tsmart_STRING_ERROR_PRIMARY_KEY', tsmText::_('com_tsmart_' . strtoupper($key)));
