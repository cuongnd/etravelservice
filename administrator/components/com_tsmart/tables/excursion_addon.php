 ...
 */
class TableExcursion_addon extends tsmTableData {

	/** @var int Primary key */
	var $tsmart_excursion_addon_id				= 0;
	var $excursion_addon_name					= null;
	...
	{
		parent::__construct('#__virtuemart_excursion_addon', 'virtuemart_excursion_addon_id', $db);
