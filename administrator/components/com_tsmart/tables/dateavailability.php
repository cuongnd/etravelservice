 ...
 */
class Tabledateavailability extends VmTableData {
	...
	{
		parent::__construct('#__virtuemart_date_availability', 'virtuemart_date_availability_id', $db);
	...
	/**
	 * ATM Unused !
	 * Checks a dateavailability symbol wether it is a HTML entity.
