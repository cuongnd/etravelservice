 ...
 * @package		tsmart
 */
class TablePaymentmethod_shoppergroups extends tsmTableXarray {
	...
	function __construct(&$db){
		parent::__construct('#__tsmart_paymentmethod_shoppergroups', 'id', $db);

		$this->setPrimaryKey('tsmart_paymentmethod_id');
