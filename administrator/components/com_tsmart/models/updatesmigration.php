...
';
    ...
    function restoreSystemDefaults() {
		...
		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'uninstall_essential_data.sql';
		$this->execSQLFile($filename);

		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'uninstall_required_data.sql';
		$this->execSQLFile($filename);

		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'install.sql';
		$this->execSQLFile($filename);

		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'install_essential_data.sql';
		$this->execSQLFile($filename);

		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'install_required_data.sql';
		$this->execSQLFile($filename);
    ...
    function removeAllVMData() {
		...
		$filename = VMPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_tsmart'.DS.'install'.DS.'uninstall_data.sql';
		$this->execSQLFile($filename);
