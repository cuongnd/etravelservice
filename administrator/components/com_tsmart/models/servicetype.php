 ...
 * @subpackage Currency
 */
class tsmartModelservicetype extends tmsModel {
	...
	function getListQuery()
	{
		...
		$query->select('servicetype.*')
			->from('#__tsmart_service_type AS servicetype')
		;
	...
	function getItemList($search='') {
		...
		$data = $this->exeSortSearchListQuery(0,'*',' FROM `#__tsmart_service_type`',$whereString,'',$this->_getOrdering());
