...
<div class="vendor-details-view vendor-view-default">
	...
	foreach ( $this->vendors as $vendor ) {
		...
		// vendor Elements
		$vendorsLink = JRoute::_('index.php?option=com_tsmart&view=vendor&tsmart_vendor_id=' . $vendor->tsmart_vendor_id, FALSE);
		$vendorIncludedProductsURL = JRoute::_('index.php?option=com_tsmart&view=category&tsmart_vendor_id=' . $vendor->tsmart_vendor_id, FALSE);
