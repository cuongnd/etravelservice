	...
	<div style="background-color: #e6e6e6;" width="100%">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
			    <tr>
				<td >
				    <?php echo tsmText::sprintf('com_tsmart_WELCOME_VENDOR', $this->vendor->vendor_store_name); ?>
				    <br />
				</td>
			    </tr>
			</table>
			...
			<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr >
				<th width="100%">
				    <?php echo tsmText::_('com_tsmart_VENDOR_CONTACT').' '.$this->vendor->vendor_name ?>
				</th>
			    </tr>
			    <tr>
				<td valign="top" width="100%">
				    <?php
				    echo tsmText::sprintf('com_tsmart_QUESTION_MAIL_FROM', $this->user['name'], $this->user['email']) . "<br />";
