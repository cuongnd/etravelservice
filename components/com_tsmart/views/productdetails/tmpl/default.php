                                            ...
                                            <div data-tsmart_price_id="<?php echo $trip->tsmart_price_id ?>"
                                                ...
                                                <div class="span12">
                                                    ...
                                                    <span class="price"
                                                        ...
                                                        <div class="span2">
                                                            <a href="javascript:void(0)"
                                                               class="btn-collapse <?php echo $this->state->get('filter.start_date') ? '' : ' required-select-date ' ?>" <?php echo $this->state->get('filter.start_date') ? ' data-toggle="collapse" ' : '' ?>
                                                    ...
                                                    <div id="trip-<?php echo $i ?>"
                                                         class="row-fluid body-item collapse">
                                                        <?php
