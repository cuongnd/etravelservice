...
<div class="buttonBar-right">
	...
	&nbsp;
	<button class="button" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_tsmart&view=user', FALSE); ?>'" ><?php echo tsmText::_('com_tsmart_CANCEL'); ?></button>
</div>
<?php }
...
if(!empty($this->tsmart_userinfo_id)){
	echo '<input type="hidden" name="tsmart_userinfo_id" value="'.(int)$this->tsmart_userinfo_id.'" />';
}
?>
