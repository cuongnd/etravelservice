...
<div class="buttonBar-right">
	...
	&nbsp;
	<button class="button" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user', FALSE); ?>'" ><?php echo tsmText::_('COM_VIRTUEMART_CANCEL'); ?></button>
</div>
<?php }
