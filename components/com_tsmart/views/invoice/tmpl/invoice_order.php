...
<h1><?php echo tsmText::_('com_tsmart_INVOICE').' '.$this->invoiceNumber; ?> </h1>
<?php }
} elseif ($this->doctype == 'deliverynote') { ?>
<h1><?php echo tsmText::_('com_tsmart_DELIVERYNOTE'); ?> </h1>
<?php } elseif ($this->doctype == 'confirmation') { ?>
<h1><?php echo tsmText::_('com_tsmart_CONFIRMATION'); ?> </h1>
...
<?php if ($this->doctype == 'invoice') { ?>
     <tr>
	<td class="orders-key"><strong><?php echo tsmText::_('com_tsmart_ORDER_PRINT_TOTAL') ?></strong></td>
