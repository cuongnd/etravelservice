...
if (!empty($this->vendor->vendor_store_desc) and tsmConfig::get('show_store_desc', 1)) { ?>
...
if ($this->categories and tsmConfig::get('show_categories', 1)) echo $this->renderVmSubLayout('categories',array('categories'=>$this->categories));
