...
<h3><?php echo tsmText::_ ('COM_VIRTUEMART_CART_CHANGE_SHOPPER'); ?></h3>
	...
	<table cellspacing="0" cellpadding="0" border="0" style="border:0px !important;">
		<tr style="border:0px;">
			<td  style="border:0px;">
				...
				<input type="submit" name="searchShopper" title="<?php echo tsmText::_('COM_VIRTUEMART_SEARCH'); ?>" value="<?php echo tsmText::_('COM_VIRTUEMART_SEARCH'); ?>" class="button" style="margin-left: 10px;"/>
			</td>
			...
			<td style="border:0px;">
				<input type="submit" name="changeShopper" title="<?php echo tsmText::_('COM_VIRTUEMART_SAVE'); ?>" value="<?php echo tsmText::_('COM_VIRTUEMART_SAVE'); ?>" class="button" style="margin-left: 10px;"/>
		...
		<tr style="border:0px;">
			...
			<td colspan="2" style="border:0px;">
				<?php if($this->adminID && $currentUser != $this->adminID) { ?>
					<b><?php echo tsmText::_('COM_VIRTUEMART_CART_ACTIVE_ADMIN') .' '.JFactory::getUser($this->adminID)->name; ?></b>
				<?php } ?>
