...
if (!empty($product->customfieldsSorted[$position])) {
	...
	<div class="<?php echo $class?>">
		...
		<div class="product-fields-title-wrapper"><span class="product-fields-title"><strong><?php echo tsmText::_ ($field->custom_title) ?></strong></span>
			<?php if ($field->custom_tip) {
				echo JHtml::tooltip (tsmText::_($field->custom_tip), tsmText::_ ($field->custom_title), 'tooltip.png');
			} ?>
		</div> <?php
		}
		$custom_title = null;
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			?><div class="product-field product-field-type-<?php echo $field->field_type ?>">
				...
				if (!empty($field->custom_desc)){
					?><div class="product-field-desc"><?php echo tsmText::_($field->custom_desc) ?></div> <?php
				}
				?>
			</div>
		<?php
