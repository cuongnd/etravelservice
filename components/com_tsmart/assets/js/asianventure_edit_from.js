(function ($) {
    ...
    $.asianventure_edit_from = function (element, options) {
        ...
        plugin.init = function () {
            ...
            if(small_form==1)
            {
                $('body.admin.com_tsmart').addClass('small_form');
            }
...
*/
            ...
            if(view_height==0)
            {
                var view_height=$('.admin.com_tsmart>.container-main').height();
            }
            $('.admin.com_tsmart').height(view_height+20);
            ...
            /*if(view_height!=0) {
                ...
                $('.admin.com_tsmart,html').height(view_height);
            }*/
