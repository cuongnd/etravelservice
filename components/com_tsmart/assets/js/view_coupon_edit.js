    ...
    $.view_coupon_edit = function (element, options) {
        ...
        plugin.init = function () {
            ...
            $element.find('select[name="tsmart_hotel_id"]').change(function(){
                ...
                $.ajax({
                    type: "GET",
                    url: 'index.php?option=com_tsmart&controller=coupon&task=get_detail_hotel&tsmart_hotel_id='+tsmart_hotel_id,
                    dataType: "json",
                    data: (function () {
            ...
            $element.find('input[name="list_tour_id[]"]').click(function(){
                ...
                $.ajax({
                    type: "GET",
                    url: 'index.php?option=com_tsmart&controller=coupon&task=check_tour&tsmart_product_id='+tsmart_product_id,
                    dataType: "json",
                    data: (function () {
            ...
            $element.find('input[name="hotel_addon_type"]').change(function(){
                ...
                $.ajax({
                    type: "GET",
                    url: 'index.php?option=com_tsmart&controller=coupon&task=get_tour_avail_by_hotel_id_first_itinerary&tsmart_hotel_id='+tsmart_hotel_id,
                    dataType: "json",
                    data: (function () {
