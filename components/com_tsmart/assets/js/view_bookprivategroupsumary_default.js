//huong dan su dung
/*
 $('.view_bookprivategroupsumary_default').view_bookprivategroupsumary_default();

 view_bookprivategroupsumary_default=$('.view_bookprivategroupsumary_default').data('view_bookprivategroupsumary_default');
 console.log(view_bookprivategroupsumary_default);
 */

// jQuery Plugin for SprFlat admin view_bookprivategroupsumary_default
// Control options and basic function of view_bookprivategroupsumary_default
...
(function ($) {
    ...
    // here we go!
    $.view_bookprivategroupsumary_default = function (element, options) {
        ...
        var defaults = {
            ...
            //main color scheme for view_bookprivategroupsumary_default
    ...
    $.fn.view_bookprivategroupsumary_default = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('view_bookprivategroupsumary_default')) {
                var plugin = new $.view_bookprivategroupsumary_default(this, options);

                $(this).data('view_bookprivategroupsumary_default', plugin);
