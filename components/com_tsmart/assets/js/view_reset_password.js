//huong dan su dung
/*
 $('.view_reset_password').view_reset_password();

 view_reset_password=$('.view_reset_password').data('view_reset_password');
 console.log(view_reset_password);
 */

// jQuery Plugin for SprFlat admin view_reset_password
// Control options and basic function of view_reset_password
...
(function($) {
    ...
    // here we go!
    $.view_reset_password = function(element, options) {

        // plugin's default options
        var defaults = {
            //main color scheme for view_reset_password
    ...
    $.fn.view_reset_password = function(options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function() {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('view_reset_password')) {
                var plugin = new $.view_reset_password(this, options);

                 $(this).data('view_reset_password', plugin);
