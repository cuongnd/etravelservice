...
class ComDocmanControllerList extends ComDefaultControllerResource
{
    ...
    public function getRequest()
    {
        ...
        if (!isset($request->slug) && isset($request->path)) {
            ...
            // Force the slug to the value in the request since in Joomla 3.2+ the persisted value
            // in the session gets pushed to the request
            $request->slug = KRequest::get('get.slug', 'slug', '');
        }
