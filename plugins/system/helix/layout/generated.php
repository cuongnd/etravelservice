    ...
    <div id="columnsettingbox" style="display: none;">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="basic">
                ...
                <div id="spanwidth">
                    ...
                    <select class="possiblewidths">
                        <option value="1">col-lg-1</option>
                        <option value="2">col-lg-2</option>
                        <option value="3">col-lg-3</option>
                        <option value="4">col-lg-4</option>
                        <option value="5">col-lg-5</option>
                        <option value="6">col-lg-6</option>
                        <option value="7">col-lg-7</option>
                        <option value="8">col-lg-8</option>
                        <option value="9">col-lg-9</option>
                        <option value="10">col-lg-10</option>
                        <option value="11">col-lg-11</option>
                ...
                <div id="spanoffset">
                    ...
                    <select class="possibleoffsets">
                        ...
                        <option value="1">col-lg-offset-1</option>
                        <option value="2">col-lg-offset-2</option>
                        <option value="3">col-lg-offset-3</option>
                        <option value="4">col-lg-offset-4</option>
                        <option value="5">col-lg-offset-5</option>
                        <option value="6">col-lg-offset-6</option>
                        <option value="7">col-lg-offset-7</option>
                        <option value="8">col-lg-offset-8</option>
                        <option value="9">col-lg-offset-9</option>
                        <option value="10">col-lg-offset-10</option>
                    </select>
                </div>
                <div id="modchrome">
                    <label>Style: </label>
            ...
            <div class="tab-pane" id="responsive">
                <label class="checkbox"> <input type="checkbox" value="visible-xs">Visible Phone</label>
                <label class="checkbox"> <input type="checkbox" value="visible-sm">Visible Tablet</label>
                <label class="checkbox"> <input type="checkbox" value="visible-md">Visible Desktop</label>
                <label class="checkbox"> <input type="checkbox" value="visible-lg">Visible Large devices Desktop</label>
                <label class="checkbox"> <input type="checkbox" value="hidden-xs">Hidden Phone</label>
                <label class="checkbox"> <input type="checkbox" value="hidden-sm">Hidden Tablet</label>
                <label class="checkbox"> <input type="checkbox" value="hidden-md">Hidden Desktop</label>
                <label class="checkbox"> <input type="checkbox" value="hidden-lg">Hidden Large devices Desktop</label>
            </div>
        </div>
    </div>
    <!-- Row setting popbox -->
