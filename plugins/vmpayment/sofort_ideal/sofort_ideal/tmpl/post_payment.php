...
<div class="post_payment_order_number" style="width: 100%">
	<span class=post_payment_order_number_title"><?php echo tsmText::_ ('COM_VIRTUEMART_ORDER_NUMBER'); ?> </span>
...
<div class="post_payment_transaction" style="width: 100%">
	<span class="post_payment_transaction_title"><?php echo tsmText::_ ('VMPAYMENT_SOFORT_RESPONSE_TRANSACTION'); ?> </span>
	<?php echo  $viewData['paymentInfos']->sofort_ideal_response_transaction; ?>
</div>
<?php } ?>
<div class="post_payment_order_total" style="width: 100%">
	<span class="post_payment_order_total_title"><?php echo tsmText::_ ('COM_VIRTUEMART_ORDER_PRINT_TOTAL'); ?> </span>
