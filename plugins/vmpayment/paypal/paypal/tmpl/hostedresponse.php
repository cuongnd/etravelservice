...
<table>
	<tr>
    	<td><?php echo tsmText::_('VMPAYMENT_PAYPAL_API_PAYMENT_NAME'); ?></td>
        <td><?php echo $payment_name; ?></td>
    </tr>

	<tr>
    	<td><?php echo tsmText::_('COM_VIRTUEMART_ORDER_NUMBER'); ?></td>
        <td><?php echo $order['details']['BT']->order_number; ?></td>
    </tr>
	<tr>
    	<td><?php echo tsmText::_('VMPAYMENT_PAYPAL_API_AMOUNT'); ?></td>
        <td><?php echo $payment->mc_gross . ' ' . $payment->mc_currency; ?></td>
    </tr>
	<?php if ($success) { ?>
	<tr>
    	<td><?php echo tsmText::_('VMPAYMENT_PAYPAL_API_TRANSACTION_ID'); ?></td>
	...
	<tr>
    	<td><?php echo tsmText::_('VMPAYMENT_PAYPAL_API_ERROR_CODE'); ?></td>
        <td><?php echo $responseData['L_ERRORCODE0']; ?></td>
    </tr>
	<?php } ?>
	<?php if (isset( $responseData['L_LONGMESSAGE0']) ) { ?>
	<tr>
    	<td><?php echo tsmText::_('VMPAYMENT_PAYPAL_API_ERROR_DESC'); ?></td>
