...
<script type="text/javascript">
	...
	klarna.lang_companyNotAllowed = '<?php echo tsmText::_ ('VMPAYMENT_KLARNA_COMPANY_NOT_ALLOWED'); ?>';
	...
	klarna.lang_personNum = '<?php echo tsmText::_ ('VMPAYMENT_KLARNA_PERSON_NUMBER'); ?>';
	klarna.lang_orgNum = '<?php echo tsmText::_ ('VMPAYMENT_KLARNA_ORGANISATION_NUMBER'); ?>';
...
<div class="klarna_box_top">
	<div id="klarna_box_<?php echo $sType ?>_top_right" class="klarna_box_top_right">
		...
		<div class="klarna_box_top_agreement">
			...
			<a href="javascript:ShowKlarnaPopup('<?php echo $viewData["payment_params"]["eid"]; ?>', '<?php echo $popupTotal; ?>','<?php echo $sType; ?>')">
				<?php echo tsmText::_ ('VMPAYMENT_KLARNA_KLARNA_'.$sType.'_AGREEMENT'); ?>
			</a>
		...
		<div class="klarna_box_bottom_languageInfo">
			<img src="<?php echo VMKLARNAPLUGINWEBASSETS . '/images/' ?>share/notice.png"
			     alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_LANGUAGESETTING_NOTE_' . $code2); ?>"/>
		</div>
	</div>
	<?php
	if ($sType == 'spec') {
	...
	<img class="klarna_logo" src="<?php echo $logo ?>"
	     alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_IMG_LOGO_'.$sType); ?>"/>
</div>
...
<div class="klarna_box_bottom_left">
	<div class="klarna_box_bottom_content">
		...
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_' . $sType . '_PAYMENT'); ?></div>
		<ol id="paymentPlan">
			<?php
...
<?php // Now it is also asked for account payments
		if ($sType == 'invoice') { ?>
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_INVOICE_TYPE'); ?></div>
		...
		<div class="klarna_box_bottom_radio_title" style="float: left">
			<label for="private"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_INVOICE_TYPE_PRIVATE'); ?></label>
		</div>
		...
		<div class="klarna_box_bottom_radio_title" style="float: none">
			<label for="company"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_INVOICE_TYPE_COMPANY'); ?></label>
		</div>
		<div class="klarna_box_bottom_input_combo"
		     style="width: 100%; display: none" id="invoice_box_company">
			<div id="left" style="width: 60%">
				<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_COMPANY_NAME'); ?></div>
				<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_COMPANY_NAME'); ?>" type="text"
...
<?php if ($code2 != 'se') { ?>
	...
	<div class="klarna_box_bottom_title"
	     id="invoice_perOrg_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_PERSON_NUMBER'); ?></div>
	<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_SOCIALNUMBER_' . strtoupper ($code2)); ?>" type="text"
...
<div class="klarna_box_bottom_input_combo">
	<div class="klarna_left" style="width: 60%">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_FIRST_NAME'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_FIRSTNAME'); ?>" type="text" name="<?php echo $sType ?>_klarna_firstName"
			   value="<?php echo $viewData['payment_params']['fields']['first_name']; ?>" style="width: 98%"/>
	</div>
	<div class="klarna_right" style="width: 40%">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_LAST_NAME'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_LASTNAME'); ?>" type="text" name="<?php echo $sType ?>_klarna_lastName"
			   value="<?php echo $viewData['payment_params']['fields']['last_name']; ?>" style="width: 100%"/>
	</div>
</div>
	<?php if ($code2 == 'de' or $code2 == 'nl') { ?>
	<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_SEX'); ?></div>
	<input type="radio" name="<?php echo $sType ?>_klarna_gender" value="1" id="<?php echo $sType ?>_male"
	       class="Klarna_radio gender"/>
	<div class="klarna_box_bottom_radio_title" style="float: left">
		<label for="<?php echo $sType ?>_male"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_SEX_MALE'); ?></label>
	</div>
	<input type="radio" name="<?php echo $sType ?>_klarna_gender" value="0" id="<?php echo $sType ?>_female"
	       class="Klarna_radio gender"/>
	<div class="klarna_box_bottom_radio_title" style="float: none">
		<label for="<?php echo $sType ?>_female"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_SEX_FEMALE'); ?></label>
	</div>
	<?php } ?>
<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_PHONE_NUMBER'); ?></div>
<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_PHONENUMBER'); ?>" type="text" name="<?php echo $sType ?>_klarna_phone"
...
<div class="klarna_box_bottom_input_combo">
	<div class="klarna_left" style="width: <?php echo  $klarna_box_street ?>">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_ADDRESS_STREET'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_STREETADDRESS'); ?>" type="text" name="<?php echo $sType ?>_klarna_street"
	...
	<div class="<?php echo  $klarna_class ?>" style="width: <?php echo  $klarna_box_house ?>">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_ADDRESS_HOMENUMBER'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_HOUSENUMBER'); ?>" type="text" name="<?php echo $sType ?>_klarna_homenumber"
	...
	<div class="klarna_right" style="width: <?php echo  $klarna_box_ext ?>">
		<div
			class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_ADDRESS_HOUSENUMBER_ADDITION'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_HOUSE_EXTENSION'); ?>" type="text"
...
<div class="klarna_box_bottom_input_combo" style="width: 100%">
	<div class="klarna_left" style="width: 60%">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_ADDRESS_ZIP'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_ZIP'); ?>" type="text" name="<?php echo $sType ?>_klarna_zipcode"
			   value="<?php echo $viewData['payment_params']['fields']['zip']; ?>" style="width: 98%"/>
	</div>
	<div class="klarna_right" style="width: 40%">
		<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_ADDRESS_CITY'); ?></div>
		<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_CITY'); ?>" type="text" name="<?php echo $sType ?>_klarna_city"
	...
	?>
<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_SOCIALSECURITYNUMBER'); ?></div>
<div class="klarna_box_bottom_content_loader">
	<img src="<?php echo VMKLARNAPLUGINWEBASSETS . '/images/' ?>share/loader1.gif" alt=""/>
</div>
<input type="text" alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_SOCIALNUMBER_SE'); ?>"
       name="<?php echo $sType ?>_klarna_socialNumber" value="<?php echo $viewData['payment_params']['fields']['socialNumber']; ?>"
       class="Klarna_pnoInputField"/>

<div class="referenceDiv" style="display: none">
	<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_REFERENCE'); ?></div>
	<input type="text" alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_REFERENCE'); ?>" name="<?php echo $sType ?>_klarna_reference"
		   value="<?php echo $viewData['payment_params']['fields']['reference']; ?>" class="Klarna_fullwidth"/>
</div>
<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_EMAIL'); ?></div>
<input alt="<?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_EMAIL'); ?>" type="text" name="<?php echo $sType ?>_klarna_emailAddress"
...
<div class="klarna_box_bottom_address" style="display: none">
	<div class="klarna_box_bottom_address_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_DELIVERY_ADDRESS'); ?></div>
...
if ($code2 == 'de' || $code2 == 'nl') {
	?>
<div class="klarna_box_bottom_title"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_BIRTHDAY'); ?></div>
<div class="klarna_box_bottom_input_combo" style="width: 100%">
	<div class="klarna_left" style="width: 30%">
		<select style="width: 98%" name="<?php echo $sType ?>_klarna_birth_day"
		        class="selectBox_bday">
			<option value="0"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_DATE_DAY'); ?></option>
	...
	<div class="klarna_left" style="width: 40%">
		<select style="width: 98%" name="<?php echo $sType ?>_klarna_birth_month" class="selectBox_bmonth">
			<option value="0" selected="selected"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_DATE_MONTH'); ?></option>
			<option value="01"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_1'); ?></option>
			<option value="02"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_2'); ?></option>
			<option value="03"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_3'); ?></option>
			<option value="04"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_4'); ?></option>
			<option value="05"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_5'); ?></option>
			<option value="06"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_6'); ?></option>
			<option value="07"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_7'); ?></option>
			<option value="08"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_8'); ?></option>
			<option value="09"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_9'); ?></option>
			<option value="10"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_10'); ?></option>
			<option value="11"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_11'); ?></option>
			<option value="12"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_MONTH_12'); ?></option>
		</select>
	</div>
	<div class="klarna_right" style="width: 30%">
		<select style="width: 100%" name="<?php echo $sType ?>_klarna_birth_year" class="selectBox_year">
			<option selected="0"><?php echo tsmText::_ ('VMPAYMENT_KLARNA_DATE_YEAR'); ?></option>
		</select>
	</div>
</div>
...
<div class="klarna_box_bottom_input_combo" style="width: 100%">
	<div class="klarna_box_bottom_title" style="width: 90%; margin-top: 3px">
		<em><?php echo tsmText::_ ('VMPAYMENT_KLARNA_NOTICE_BILLING_SAME_AS_SHIPPING'); ?></em>
	</div>
</div>
	<?php
}
