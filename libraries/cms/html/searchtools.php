...
abstract class JHtmlSearchtools
{
	...
	public static function vmsort($title, $order, $direction = 'asc', $selected = 0, $task = null, $new_direction = 'asc', $tip = '', $icon = null,
		$formName = 'adminForm')
	{
		$direction = strtolower($direction);
		$orderIcons = array('icon-arrow-up-3', 'icon-arrow-down-3');
		...
		return JLayoutHelper::render('joomla.searchtools.grid.vmsort', $data);
	}
}
